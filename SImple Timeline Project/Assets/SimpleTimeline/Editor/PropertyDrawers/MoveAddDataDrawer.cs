...
[CustomPropertyDrawer(typeof(MoveAddData))]
public class MoveAddDataDrawer : BaseCommandDrawer
{
    ...
    public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
    {
        ...
        EditorGUI.LabelField(titleRect, "Move Add Command", EditorStyles.boldLabel);
