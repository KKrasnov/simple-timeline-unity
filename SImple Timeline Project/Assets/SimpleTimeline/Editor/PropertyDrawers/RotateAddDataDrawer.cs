...
[CustomPropertyDrawer(typeof(RotateAddData))]
public class RotateAddDataDrawer : BaseCommandDrawer
{
    ...
    public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
    {
        ...
        EditorGUI.LabelField(titleRect, "Rotate Add Command", EditorStyles.boldLabel);
        ...
        if (foldoutStates[propertyPath])
        {
            ...
            Rect offsetRect = new Rect(contentRect.x, timeRect.y + lineHeight + spacing, contentRect.width, lineHeight);
